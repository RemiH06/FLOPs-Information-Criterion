// No uso realmente este código, lo dejo para que se vea mi primer approach a una estimación de los FLOPs
// Este file puede determinar un conteo para aproximadamente 40 modelos
// El approach que terminé utilizando fue intercepción del contexto para distintas librerías
#pragma once
#include <cstdint>
#include <string>
#include <algorithm>
